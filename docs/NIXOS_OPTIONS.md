...
This document details the configuration options available for the LazyLibrarian NixOS module.
...
## services.lazylibrarian.group



Group the service runs as. A group is created when left at the default.
...
## services.lazylibrarian.openFirewall



Whether to open \<option>port\</option> in the firewall.
...
## services.lazylibrarian.user



User the service runs as. A system user is created when left at the default.
